...
public class Console {
    ...
    public String[] setKeysForBooking() {
        ...
        while (!dateKey.matches("([0-9]{2}).([0-9]{2}).2022")){
            System.out.println("Wrong Data! Enter Date for Booking Again!");
        ...
        while (numberKey > 3) {
            System.out.println("Wrong Data! Enter Number of Tickets for Booking Again!");
